Created by Joseph Waldron and Moiez Qamar

To run this program open it as a project in a java compatible ide and run the RunMe.java file

Or click on the path search bar in the HackKean 2022 folder and type "cmd"
